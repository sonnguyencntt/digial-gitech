...
Route::group(['prefix' => 'administrator'], function () {
    ...
    Route::group(['prefix' => 'posts'], function () {
        ...
        Route::get('/{Category}/edit', 'Manage\PostsController@edit')->name('manage.posts.edit');
        Route::put('/{Category}', 'Manage\PostsController@update')->name('manage.posts.update');
        Route::delete('/{Category}', 'Manage\PostsController@destroy')->name('manage.posts.destroy');
        Route::get('/{Category}', 'Manage\PostsController@show')->name('manage.posts.show');
    });
