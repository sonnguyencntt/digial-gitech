        ...
        <div class="row" id="row-252565475">
            ...
            <div id="col-513256020" class="col medium-6 small-12 large-6">
                <div class="col-inner">
                    ...
                    <p>Nếu bạn có yêu cầu  hoặc thắc mắc, xin vui lòng điền vào mẫu dưới đây và chúng tôi sẽ hỗ trợ bạn
                    ...
                    <div role="form" class="wpcf7" id="wpcf7-f5-p69-o2" lang="vi" dir="ltr">
                        ...
                        <form action="{{ route('contact.store') }}" method="post" class="wpcf7-form init"
                            ...
                            <p><span class="wpcf7-form-control-wrap text-765"><input type="text" name="full_name"
                                ...
                                <span class="wpcf7-form-control-wrap textarea-215"><textarea name="note" cols="40"
                                        rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false"
                                        placeholder="Ghi chú (nếu có)"></textarea></span><br />
                            ...
                            <p style="display: none !important;"><label>&#916;<textarea name="_wpcf7_ak_hp_textarea"
                                    ...
                                    id="ak_js" name="_wpcf7_ak_js" value="203" />
                                <script>
