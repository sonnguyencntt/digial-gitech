            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                  @include('components.user.popup_error')
                    ...
                    <a class="btn btn-primary" href="{{ route('manage.banner.create' , $store_code) }}">Thêm mới {{$title}}</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a type="button" class="btn btn-default" title="Chỉnh sửa"
                                                href="{{ route('manage.banner.edit', ["store_code"=>$store_code , "banner"=>$value->id]) }}"><i
