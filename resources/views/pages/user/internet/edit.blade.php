      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" id = "postForm" action="{{route("user.service_internet.update" , ["store_code" => $badges->store_code , "internet"=>$internet->id])}}" method="POST"   enctype="multipart/form-data">
              @csrf
              @method('put')
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="sort_number"
                      value="{{ $internet->sort_number}}" placeholder="Nhập tên" autocomplete="off" />
