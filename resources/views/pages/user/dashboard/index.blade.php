        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
              ...
              <a href="{{ route('user.service_internet.index' , $badges->store_code) }}" class="small-box-footer">Chi tiết <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-olive">
              ...
              <a href="{{ route('user.service_camera.index' , $badges->store_code) }}" class="small-box-footer">Chi tiết <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-purple">
              ...
              <a href="{{ route('user.service_play.index' , $badges->store_code) }}" class="small-box-footer">Chi tiết <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
