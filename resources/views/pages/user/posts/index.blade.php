...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                  @include('components.user.popup_error')
                    ...
                    <a class="btn btn-primary" href="{{ route('user.posts.create' , $badges->store_code) }}">Thêm mới {{$title}}</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a type="button" class="btn btn-default" title="Chỉnh sửa"
                                                href="{{ route('user.posts.edit', ["store_code" => $badges->store_code , "posts"=>$value->id]) }}"><i
            ...
            <!-- remove brand modal -->
            @include('pages.user.posts.child.remove_popup');
          </section>
        <!-- /.content -->
    </div>
@stop
