      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <form role="form" action="{{route("manage.profile.update" , $user->id)}}" method="POST" onsubmit = "return validate();">
              @csrf
              @method('put')
              <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{$user->email}}" autocomplete="off" disabled>
