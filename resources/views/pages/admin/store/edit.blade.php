      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="{{route("manage.store.update" , $store->id)}}" method="POST"   enctype="multipart/form-data">
              @method('PUT')  
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="store_code" placeholder="Tên miển truy cập" value="{{$store->store_code}}" disabled>
                    <span class="input-group-addon">.{{$domain_name}}</span>
                    </div>    
                </div>
                <div class="form-group">
                  <label for="product_name" >Tên cửa hàng</label>
                    <input type="text" name="name" class="form-control" placeholder="Tên cửa hàng" value="{{$store->name}}">
                </div>
                <div class="form-group">
                  <label for="product_name" >Địa chỉ</label>
                    <input type="text" name="address" class="form-control" placeholder="Địa chỉ" value="{{$store->address}}">
                </div>
