      ...
      <div class="col-md-12 col-xs-12">
        <div class="col-md-9 col-xs-9">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a class="btn btn-primary" href="{{ route('manage.store.create') }}">Thêm mới {{$title}}</a>
              ...
              <table id="manageTable" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{route("manage.dashboard.index" , $value->store_code)}}">{{ $value->name  }}</a></td>
                    ...
                    <td><a type="button" class="btn btn-default" title="Chỉnh sửa"
                        href="{{ route('manage.store.edit', $value->id) }}"><i class="fa fa-pencil"></i></a>
