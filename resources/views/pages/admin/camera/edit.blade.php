          ...
          <form role="form" id="postForm" action="{{route("manage.service_camera.update" , $camera->id)}}"
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-6 col-xs-6">
                  <div class="form-group">
                    ...
                    <img src="{{asset($camera->image_url)}}" width="150" height="150" class="img-circle">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{$camera->name}}"
                      placeholder="Nhập tên" autocomplete="off" />
    
                  </div>
                  <div class="form-group">
                    <label for="product_name">Giá</label>
                    <input type="text" class="form-control" id="name" name="price" value="{{$camera->price}}"
                      placeholder="Nhập giá" autocomplete="off" />
    
                  </div>
                  <div class="form-group">
                    <label for="product_name">Giảm giá</label>
                    <input type="text" class="form-control" id="name" name="discount" value="{{$camera->discount}}"
                      placeholder="Nhập giá" autocomplete="off" />
    
                  </div>
                  <div class="form-group">
                    <label for="product_name">Màu sắc</label>
                    <input type="text" class="form-control" id="name" name="color" value="{{$camera->color}}"
                      placeholder="Nhập..." autocomplete="off" />
    
                  </div>
                  <div class="form-group">
                    <label for="product_name">Lưu trữ dữ liệu</label>
                    <input type="text" class="form-control" id="name" name="storage" value="{{$camera->storage}}"
                      placeholder="Nhập..." autocomplete="off" />
                ...
                <div class="col-md-6 col-xs-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="resolution" value="{{$camera->resolution}}"
                      placeholder="Nhập..." autocomplete="off" />
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="connection" value="{{$camera->connection}}"
                  placeholder="Nhập..." autocomplete="off" />

              </div>
              <div class="form-group">
                <label for="product_name">Giảm nhiễu khi ánh sáng yếu</label>
                <input type="text" class="form-control" id="name" name="noise_reduction_in_low_light"
                  value="{{$camera->noise_reduction_in_low_light}}" placeholder="Nhập..." autocomplete="off" />

              </div>
              <div class="form-group">
                <label for="product_name">Cân bằng ánh sáng trắng</label>
                <input type="text" class="form-control" id="name" name="balance_white_light"
                  value="{{$camera->balance_white_light}}" placeholder="Nhập..." autocomplete="off" />

              </div>
              <div class="form-group">
                <label for="product_name">Kháng nước</label>
                <input type="text" class="form-control" id="name" name="water_resistant"
                  value="{{$camera->water_resistant}}" placeholder="Nhập..." autocomplete="off" />

              </div>
              <div class="form-group">
                <label for="product_name">Bảo hành</label>
                <input type="text" class="form-control" id="name" name="insurance" value="{{$camera->insurance}}"
                  placeholder="Nhập..." autocomplete="off" />
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="customer_care"
                  value="{{$camera->customer_care}}" placeholder="Nhập..." autocomplete="off" />
              ...
              <div class="form-group">
                ...
                <select name="category_id" id="" class="form-control">
                  ...
                  <option value="{{$value->id}}" {{$value->id == $camera->category_id ? "selected" : ""}}
                    >{{$value->name}}</option>
                  @endforeach
