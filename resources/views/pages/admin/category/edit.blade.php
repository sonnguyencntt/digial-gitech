      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="{{route("manage.category.update" , ["store_code"=>$store_code , "category" => $category->id])}}" method="POST"   enctype="multipart/form-data">
              @method('PUT')  
              <div class="box-body">
        
                  <div class="form-group">
                    <label for="product_name" >Ngày đăng</label>
                    <input type="text" class="form-control" id="created_at" value="{{$category->created_at}}"  name="created_at" placeholder="Tự động" autocomplete="off"  disabled />
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" value="{{$category->name}}" name="name" placeholder="Nhập tiêu đề" autocomplete="off" />
