      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" id = "postForm" action="{{route("manage.service_internet.update" , ["store_code" => $store_code , "internet"=>$internet->id])}}" method="POST"   enctype="multipart/form-data">
              @csrf
              @method('put')
              <div class="box-body">
